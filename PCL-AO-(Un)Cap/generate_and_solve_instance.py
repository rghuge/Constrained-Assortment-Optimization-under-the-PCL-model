...
# -*- coding: utf-8 -*-
"""
Created on Mon May  4 16:32:16 2020
...
def generate_and_solve_instance(gamma, P0, instance_type, n, capacity):
    
    soln_list = []
    
    # Filename in form I/C_n_gamma_P0
    option = ''
    if (instance_type == 0) :
        option = 'I'
    else :
    ...
    f = 'UnconsResults/' + option + '_' + str(n) + '_' + str(gamma) + '_' + str(P0) + '_testing.csv'
